...
uint64_t reverseByteOrder64(uint64_t v64) {
  ...
  v_r = (v64 & 0xff00000000000000) >> 56 | (v64 & 0x00ff000000000000) >> 40 |
        (v64 & 0x0000ff0000000000) >> 24 | (v64 & 0x000000ff00000000) >> 8 |
        (v64 & 0x00000000ff000000) << 8 | (v64 & 0x0000000000ff0000) << 24 |
        (v64 & 0x000000000000ff00) << 40 | (v64 & 0x00000000000000ff) << 56;
...
uint64_t hton64(uint64_t v64) {
  return IS_BIG_ENDIAN ? v64 : reverseByteOrder64(v64);
}

uint64_t ntoh64(uint64_t v64) {
  return IS_BIG_ENDIAN ? v64 : reverseByteOrder64(v64);
}
